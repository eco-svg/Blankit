...
def _generate_character_sheet(user_id, user_context, notes_count, streak):
    ...
    prompt = (
        ...
        "   EXCEPTION — software/tech skills: be specific. Use 'Full-Stack Development', 'Frontend Development', "
        "   'Backend Development', 'iOS Development', 'Machine Learning', 'DevOps', etc. "
        "   Infer from evidence: a shipped web app with both UI and API = 'Full-Stack Development'. "
        "   Mostly UI/design work = 'Frontend Development'. API/server/DB only = 'Backend Development'. "
        "   Do NOT collapse all software work into a single 'Software Development' catch-all.\n"
